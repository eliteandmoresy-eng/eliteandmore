...
- تبويبات (Tabs) باسم تصنيفات البرند + تبويب "الكل".
...
- **BrandCategoryTabs:** تبويبات لتصنيفات البرند + تبويب "الكل".
...
- Slug *.
- البرند * (Dropdown).
- التصنيف * (Dropdown يُفلتر حسب البرند المختار).
- الوصف (textarea كبير).
...
27. أنشئ كل endpoints في القسم 8.
